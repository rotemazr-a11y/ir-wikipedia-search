...
GOOGLE_ACCOUNT_NAME="rotemazr" # without the @post.bgu.ac.il or @gmail.com part
...
# 3. Create the instance. Using e2-standard-2 for better performance (2 vCPU, 8GB RAM)
# You can use e2-micro for testing but it may be slow for the full index
